...
// ***** VDMTOOLS START Name=tiles KEEP=NO
  private volatile HashSet tiles = new HashSet();
  ...
  public Game (final Integer n) throws CGException {
    ...
    vdm_init_Game();
    {
      ...
      HashMap res_m_4 = new HashMap();
      {
        ...
        e_set_10 = new HashSet();
        int ubi_13 = boardLimit.intValue();
        for (int count_14 = new Integer(0).intValue(); count_14 <= ubi_13; count_14++) 
          e_set_10.add(new Integer(count_14));
        Integer x = null;
        Integer y = null;
        HashSet e_set_17 = e_set_10;
        {
          for (Iterator enm_19 = e_set_17.iterator(); enm_19.hasNext(); ) {

            Integer elem_18 = UTIL.NumberToInt(enm_19.next());
            y = elem_18;
            for (Iterator enm_16 = e_set_10.iterator(); enm_16.hasNext(); ) {

              Integer elem_15 = UTIL.NumberToInt(enm_16.next());
              x = elem_15;
              Utilities.Pos md_5 = null;
              md_5 = new Utilities.Pos(x, y);
              res_m_4.put(md_5, new quotes.empty());
            }
          }
        }
      }
      rhs_3 = res_m_4;
      board = (HashMap) UTIL.clone(rhs_3);
      HashMap rhs_20 = new HashMap();
      rhs_20 = new HashMap();
      rhs_20.put(new quotes.blue(), new Integer(0));
      rhs_20.put(new quotes.yellow(), new Integer(0));
      rhs_20.put(new quotes.red(), new Integer(0));
      rhs_20.put(new quotes.green(), new Integer(0));
      score = (HashMap) UTIL.clone(rhs_20);
      initializeTiles();
    }
  }
...
// ***** VDMTOOLS START Name=getTiles KEEP=NO
  public HashSet getTiles () throws CGException {
